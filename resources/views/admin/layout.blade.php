...
<html lang="en">
  ...
  <body>
    <aside>
      ...
      <div class="logo"><a href="{{ route('admin.bang-dieu-khien') }}"><img class="logo-large" src="{{ asset('admin_assets/img/logo.png') }}"/></a><img class="logo-mini" src="{{ asset('admin_assets/img/logo-mini.png') }}"/></div>
      <div class="menu">
          ...
          <ul class="nav">
            ...
            <li class="nav-item"><a class="nav-link waves-effect" data-toggle="collapse" href="#product-manager" aria-expanded="false" aria-controls="ui-basic"><i class="mdi mdi-shopify menu-icon"></i><span class="menu-title">Quản lý bài viết</span></a><i class="mdi mdi-chevron-down menu-down" data-toggle="collapse" href="#product-manager" aria-expanded="false" aria-controls="ui-basic"></i>
              <div class="collapse show" id="product-manager">
                <ul class="nav flex-column sub-menu">
                  <li class="nav-item"><a class="nav-link" href="{{ route('admin.danh-sach-san-pham') }}">Danh sách bài viết</a></li>
                  <li class="nav-item"><a class="nav-link" href="{{ route('admin.them-san-pham') }}">Thêm bài viết</a></li>
                </ul>
              </div>
            </li>
          </ul>
    ...
    <main>
      <header>
        <div class="container-fluid">
          ...
          <div class="username">Trí Việt</div>
          <div class="custom">
            <ul>
              ...
              <li><a href="doi-mat-khau.html"><i class="mdi mdi-key-change"></i><span>Đổi mật khẩu</span></a></li>
              <li><a href="login.html"><i class="mdi mdi-logout"></i><span>Đăng xuất</span></a></li>
            </ul>
          </div>
        </div>
      </header>
