...
<div class="container news-page content-body py-4">
    ...
    <div class="row">
        <div class="col-lg-8 pe-lg-4">
          <div class="faculty-section mt-5 border-top pt-5">
            <h3 class="h4 fw-bold text-primary-emphasis mb-4 text-uppercase border-start border-primary border-4 ps-3">
            ...
            @php
                $faculty_data = [
                    'KHOA HỌC MÁY TÍNH' => [
                        ['TS. Lê Nhật Duy (Trưởng khoa)', 'TS. Hồ Đắc Quới (Trưởng bộ môn)'],
                        ['PGS.TS Huỳnh Tường Nguyên (Phó trưởng khoa)', 'TS. Đặng Thị Phúc (Phó trưởng khoa)'],
                        ['TS. Phạm Thị Thiết (Phó bộ môn)', 'TS. Phạm Văn Chung']
                    ],
                    'KỸ THUẬT PHẦN MỀM' => [
                        ['ThS. Phạm Quang Trí', 'TS. Tôn Long Phước'],
                        ['TS. Nguyễn Thị Hạnh (Trưởng bộ môn)', 'ThS. Bùi Đình Tiền'],
                        ['ThS. Châu Thị Bảo Hà', 'TS. Nguyễn Minh Hải']
                    ],
                    'CÔNG NGHỆ THÔNG TIN' => [
                        ['TS. Tạ Duy Công Chiến (Trưởng bộ môn)', 'TS. Trần Thị Minh Khoa'],
                        ['ThS. Hoàng Đình Hạnh', 'TS. Lê Thị Thủy']
                    ]
                ];
            @endphp

            @foreach($faculty_data as $dept => $pairs)
                <div class="dept-block mb-4">
                    <h5 class="fw-bold text-secondary small mb-2 text-uppercase">{{ $dept }}</h5>
                    <div class="table-responsive">
                        <table class="table table-bordered table-sm" style="font-size: 0.9rem;">
                            <tbody>
                                @foreach($pairs as $pair)
                                <tr>
                                    <td width="50%" class="px-3 py-2">{{ $pair[0] }}</td>
                                    <td width="50%" class="px-3 py-2">{{ $pair[1] }}</td>
                                </tr>
                                @endforeach
                            </tbody>
                        </table>
