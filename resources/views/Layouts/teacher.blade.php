...
<head>
    ...
    <title>Teacher Dashboard - HHT</title>
...
<div id="wrapper">
    <nav id="sidebar">
        <div class="sidebar-header">
            <h4 class="mb-0">HHT TEACHER</h4>
        </div>
        <ul class="list-unstyled">
            <li><a href="{{ route('teacher.courses.index') }}"><i class="mdi mdi-view-dashboard"></i>Khóa học</a></li>
            <li><a href="{{ route('profile.edit') }}"><i class="mdi mdi-account-cog"></i> Hồ sơ cá nhân</a></li>
            <li><a href="{{ route('teacher.learning-results') }}"><i class="mdi mdi-book-open-variant"></i> Kết quả học tập</a></li>
            <li><a href="{{ route('teacher.calendar') }}"><i class="mdi mdi-calendar-check"></i> Lịch học</a></li>
            <li>
